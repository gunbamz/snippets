...
const BinanceSpotLOrder = async (a) => {
  let b = a.split(" ");
  const  timestamp = Date.now();
  let param = `symbol=${b[3]}&side=${b[1]}&type=${b[2]}&quantity=${b[4]}&price=${b[0]}&timeInForce=${b[5]}&recvWindow=20000&timestamp=${timestamp}`;
...
export default BinanceSpotLOrder;